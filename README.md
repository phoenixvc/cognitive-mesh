...
### 1. Foundation — Infrastructure bedrock
...
### 3. Metacognitive — Self-awareness and oversight
...
### 5. Business Applications — The public API surface
...
- [mcowger/plexus](https://github.com/mcowger/plexus) — unified AI provider gateway (study reference for sluice integration patterns; **note: no licence file — study only, do not copy code**)
