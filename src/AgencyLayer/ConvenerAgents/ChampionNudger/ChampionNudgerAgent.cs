...
namespace CognitiveMesh.AgencyLayer.ConvenerAgents.Interfaces
{
    /// <summary>
...
namespace CognitiveMesh.AgencyLayer.ConvenerAgents.Events
{
    /// <summary>
...
namespace CognitiveMesh.AgencyLayer.ConvenerAgents.ChampionNudger
{
    using CognitiveMesh.AgencyLayer.ConvenerAgents.Events;
    using CognitiveMesh.AgencyLayer.ConvenerAgents.Interfaces;
