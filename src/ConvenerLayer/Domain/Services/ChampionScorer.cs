...
// Note: In a complete Onion Architecture, these would reside in their respective layers
...
namespace CognitiveMesh.ConvenerLayer.Core.Interfaces
{
    ...
    /// This interface is part of the Core layer and is implemented in the Infrastructure layer.
    /// </summary>
...
// --- Domain Service ---
namespace CognitiveMesh.ConvenerLayer.Domain.Services
{
    ...
    /// It depends only on abstractions defined in the Core layer.
    /// </summary>
