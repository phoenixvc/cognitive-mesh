...
public class AgentDefinition
{
    ...
    /// </summary>
    public Entities.AgentStatus Status { get; private set; }
        ...
        string contactOwner)
    {
        ...
        Status = Entities.AgentStatus.Active;
        CreatedAt = DateTimeOffset.UtcNow;
        UpdatedAt = CreatedAt;
    }
    ...
    {
        if (Status == Entities.AgentStatus.Retired)
        {
            throw new InvalidOperationException("A retired agent cannot be deprecated.");
        }
        Status = Entities.AgentStatus.Deprecated;
        UpdatedAt = DateTimeOffset.UtcNow;
    }
    ...
    public void Retire()
    {
        Status = Entities.AgentStatus.Retired;
        UpdatedAt = DateTimeOffset.UtcNow;
    }
}