...
using CognitiveMesh.FoundationLayer.AuditLogging.Models; // <-- new models (ethical/legal events)
...
namespace CognitiveMesh.FoundationLayer.AuditLogging
{
    ...
    public enum AgentAuditEventType
    {
        ...
        /// <summary>
        /// An emergency override was activated.
        /// </summary>
        EmergencyOverrideActivated,

        /// <summary>
        /// An emergency override was deactivated.
        /// </summary>
    ...
    public class AuthorityOverriddenEvent
    {
        ...
        /// </summary>
        public Dictionary<string, object> OverrideDetails { get; set; }
    }
